...
- Chief of Staff at an AI robotics company.
- Building a public library of playbooks, essays, and toolkits at nicholasayala.com.
...
<table>
  <tr>
    <td width="50%" valign="top">
      <strong>OKR Management in a Day</strong>
      <p>Repo: https://github.com/nmayalais/OKRsMatter</p>
      <p>Write-up: https://www.nicholasayala.com/blog/okr-management-in-a-day</p>
      <p><em>Summary:</em> A lightweight, practical OKR setup kit to get teams from blank page to aligned objectives in a single day.</p>
      <p><em>Impact:</em> 1-day setup workflow.</p>
    </td>
    <td width="50%" valign="top">
      <strong>ChargeMatter EV Reservations</strong>
      <p>Repo: https://github.com/nmayalais/ChargeMatter</p>
      <p>Write-up: https://www.nicholasayala.com/blog/chargematter-ev-reservations</p>
      <p><em>Summary:</em> Built a $7, 2.5-hour internal web app to make workplace EV charging fair, fast, and usable.</p>
      <p><em>Impact:</em> $7 build cost; 2.5 hours to ship.</p>
    </td>
  </tr>
</table>
...
If something here resonates, reach out through my website or LinkedIn.
